...
- **AWS CLI** is required to be installed and configured with credentials for a user with permissions to run the terraform commands that use the aws provider. [installation](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html)
